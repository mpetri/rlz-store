...
using rlz_type_uv_greedy_sp = rlz_store_static<dict_random_sample_budget<cikm_sample_block_size>,
                             dict_prune_none,
...
using rlz_type_zz_lenmul3 = rlz_store_static<dict_random_sample_budget<cikm_sample_block_size>,
                             dict_prune_none,
